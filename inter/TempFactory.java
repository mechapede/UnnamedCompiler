...
public class TempFactory {
  public ArrayList<Temporary> temps; //TODO: abstract arraylist
  ...
  public Temporary getLocal(Temporary.Type t) {
    return getLocal(t,null);
  }

  public Temporary getLocal(Temporary.Type type, String name) {
  ...
  public Temporary getTemp(Temporary.Type type, String name) {
    Temporary t = new Temporary(temps.size(),Temporary.Use.TEMPORARY,type,name);
    temps.add(t);
    return t;
  }

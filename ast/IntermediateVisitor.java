...
public class IntermediateVisitor extends Visitor {
    ...
    public Temporary visit(Function f) {
        ...
        f.decl.accept(this);
        f.body.accept(this);
        if(current.getStatementCount() < 1 || current.getStatement(current.getStatementCount()-1).getClass() != IRReturn.class ) { //should only happen for void functions
